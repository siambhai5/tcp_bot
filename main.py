...
uid=4536460656,password=700444E2B1956E9E34FA9A823F974874AA13BCBBDFD199872D9334F327F5EB32

# OR Format 2: Line-separated
# uid: 4536460656
# password: 700444E2B1956E9E34FA9A823F974874AA13BCBBDFD199872D9334F327F5EB32
...
async def Room_Spam(Uid, Rm, Nm, K, V):
    ...
    fields = {
        ...
        2: {
            1: int(Rm),  
            2: "iG:[C][B][FF0000] SHAPPNO Cᴏᴅᴇxᅠ",  
            3: {
                2: 1,
                3: 1
            },
...
🎯 Target: {target_uid}
🤖 Bot Name: —͞SHAPPNO Cᴏᴅᴇxᅠ
✅ Status: Ready to join

📱 Player will see:
"—͞SHAPPNO Cᴏᴅᴇxᅠ wants to join your team"
...
async def request_join_with_badge(target_uid, badge_value, key, iv, region):
    ...
    fields = {
        ...
        2: {
            ...
            6: "iG:[C][B][FF0000] —͞SHAPPNO Cᴏᴅᴇxᅠ",
            7: 330,
            8: 1000,
            10: region.upper(),
...
[FFDD00]━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
[00FF00][b][c]BOT MADE BY SIAM_BHAI  
"""
        else:
...
[FFDD00]━━━━━━━━━━━━━━━━━━━━━━
[00FF00][b][c]⚡ BOT MADE BY SIAM BHAI 
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"""
        else:
...
def send_likes(uid):
    try:
        ...
        likes_api_response = requests.get(
             f"https://free-like-api-ilow.onrender.com/like?uid={uid}&server_name=BD&key=STAR",
             timeout=15
        )
...
[C][B][11EAFD]‎━━━━━━━━━━━━
[C][B][DA70D6]❀️POWER BY [FFFFFF] </> SIAM_BHAI
"""
...
[FF00FF]  LIMIT REACHED TRY AGIN LATER.
...
def remove_from_whitelist(uid_to_remove):
    ...
    if uid_str == "2622605329":  # Your UID
...
[C][B][FFFF00]│[FF0000]▶[00FFFF]│[00FFFF]║[FFFFFF] SIAM_BHAI TCP BOT[FFFF00]║
...
"""
                            ...
                            if str(response.Data.uid) != "2622605329":  # Replace with your actual UID
...
"""
                        ...
                        if inPuTMsG.strip() == '/wllist':
                            ...
                            # Check if owner
                            if str(response.Data.uid) != "2622605329":  # Your UID
...
👥 Whitelisted UIDs:"""
                            ...
                            for uid in WHITELISTED_UIDS:
                                if uid != "2622605329":  # Skip owner since already shown
                                    whitelist_msg += f"\n• {uid}"
                                    count += 1
                                    if count >= 20:
...
# ==================== /luck COMMAND ====================
                        if inPuTMsG.strip() == "/luck":
                            luck_messages = [
                                "আজ তুমি  social গেলেই Mia khalifa কে GF বানাতে  পারবে ....!! ⚡",
...
#GALI SPAM MESSAGE 
                        ...
                        BLOCKED_NAMES = ["block", "SIAM", "Siam", "siam","siam_bhai","SIAM_BHAI"]  # Add your actual name
                        ...
                        if inPuTMsG.strip().startswith('/gali '):
                            ...
                            try:
                                ...
                                if len(parts) < 2:
                                    ...
                                    messages = [
                                        "[B][C]{Name} [FF0000] তোর নানী রে  [B][C] চু🙂দি",
                                        "[B][C]{Name} [00FFFF] তোর মা🙂রে ১৮০ কি.মি বে🙂গে [B][C] চু🙂দে তোরে জ🙂ন্ম দিছি",
                                        "[B][C]{Name} [FF00FF] আমি জুতা [B][C] চোর",
                                        "[B][C]{Name} আমি মানুষের [FFA500] গু খাই"
                                        "[B][C]{Name} [32CD32]আমি বো🙂কা🙂চো🙂দা",
                                        "[B][C]{Name} [FF1493]আমি গাতা",
                                        "[B][C]{Name} আমি সহ আমার ১৪ গু🙂ষ্টি🙂র [00FF00] মাথার তার ছিরা",
                                        "[B][C]{Name} [00FFFF]আমি গাধা চো🙂দা ",
                                        "[B][C]{Name} [FF1493]আমি বলোদ",
                                        "[B][C]{Name} আমি [FF0000] মাকে কু্🙂ত্তা🙂য় চু🙂দে ছিলো",
                                        "[B][C]{Name} amr [FF00FF] ABBA KUTTA",
                                        "[B][C]{Name} [00FF00] আমি শূক🙂রের ছেলে ",
                                        "[B][C]{Name} আমি [FFA500]কুত তা ",
                                        "[B][C]Bangladesh ami mc [FF0000] {Name}",
                                        "[B][C]{Name} ami [FF00FF] বা🙂ইন চো🙂দ",
                                        "[B][C]{Name} [00FF00] ami pabna thaki ",
                                        "[B][C]{Name} [FF1493]তোর আ🙂ব্বা SHAPPNO আর কু🙂ত্তা তা কখনো ভুলিস না"
                                            ]
...
#GALI SPAM MESSAGE 
                        # Add at the top with other global variables
                        BLOCKED_NAMES = ["siam", "Siam", "SIAM", "SIAM_BHAI"]  # Add your actual name
...
# FIXED HELP MENU SYSTEM - Now detects commands properly
                        ...
                        if inPuTMsG.strip().lower() in ("SIAM_BHAI", "/help", "hi", "x", "1"):
                            print(f"Help command detected from UID: {uid} in chat type: {XX}")
    

    
                            basic = """[B][FFA500]■ TEAM & MATCH ■
[B][FFA500]──────────────────
...
[B][FFA500]├─[00FF00]h [FFFFFF][code] (Join)
[B][FFA500]├─[00FF00]/exit
[B][FFA500]├─[00FF00]/sticker
...
[B][FFA500]──────────────────"""
                            ...
                            emotes = """[B][00FFFF]■ V bage spam■
[B][00FFFF]──────────────────
[B][FFD700] V bage spam
[B][00FFFF]├─[00FF00]/v1 [FFFFFF][uid]
[B][00FFFF]├─[00FF00]/v2 [FFFFFF][uid]
[B][00FFFF]├─[00FF00]/v3 [FFFFFF][uid]
[B][00FFFF]└─[00FF00]/v4 [FFFFFF][uid]
[B][00FFFF]──────────────────
[B][FFD700]ultra power 
[B][00FFFF]├─[00FF00]/spam [FFFFFF][uid]
[B][00FFFF]├─[00FF00]/spm [FFFFFF][uid] [num]
...
[B][00FFFF]──────────────────"""
                            ...
                            evo = """[B][FF00FF]■ ROOM & BADGE ■
[B][FF00FF]──────────────────
[B][FFD700] FUN & TOOLS
[B][FF00FF]├─[00FF00]/inv [FFFFFF][uid]
[B][FF00FF]├─[00FF00]/entry (uid)
[B][FF00FF]├─[00FF00]/ms [FFFFFF] [msg] [num]
[B][FF00FF]└─[00FF00]/room [FFFFFF][uid] [room_id]
[B][FF00FF]──────────────────
[B][FFD700]BADGE REQUESTS
[B][FF00FF]├─[00FF00]/v1 [FFFFFF]to [00FF00]/v5 [FFFFFF][uid]
...
[B][FF00FF]──────────────────"""
                            ...
                            spam_cmnd = """[B][8A2BE2]■ FUN & ENTERTAINMENT ■
[B][8A2BE2]──────────────────
[B][FFD700]GAMES & JOKES
[B][8A2BE2]├─[00FF7F]/love [FFFFFF][name]
[B][8A2BE2]├─[00FF7F]/coin [FFFFFF]( কয়েন গেম)
[B][8A2BE2]└─[00FF7F]/luck [FFFFFF](Luck Meter)
[B][8A2BE2]──────────────────
[B][FFD700]FUN TEXTS
[B][8A2BE2]├─[00FF7F]/love [FFFFFF][নাম] (ভালোবাসা)
[B][8A2BE2]├─[00FF7F]/dhadha[FFFFFF] (মজদি মাগ ধাঁধা)
[B][8A2BE2]├─[00FF7F]/Ga🤫li [FFFFFF][নাম] (বকা দেওয়া)
[B][8A2BE2]└─[00FF7F]/joke  [FFFFFF] (jokes)
[B][8A2BE2]──────────────────"""
                            await safe_send_message(response.Data.chat_type, spam_cmnd, uid, chat_id, key, iv)
                            await asyncio.sleep(0.6)

                            badge_cmnd = """[B][FF0000]■ SPAM & ATTACK ■
[B][FF0000]──────────────────
...
[B][FF0000]├─[00FF00]/lag [FFFFFF][tmcd]
[B][FF0000]├─[00FF00]/lag_stop
[B][FF0000]├─[00FF00]/freeze me [FFFFFF]or [00FF00]/freeze [FFFFFF][uid]
[B][FF0000]└─[00FF00] noob
[B][FF0000]──────────────────"""

                            await safe_send_message(response.Data.chat_type, badge_cmnd, uid, chat_id, key, iv)
                            await asyncio.sleep(0.2)

                            ad_cmnd = """[B][FF1493]■ MX EMOTE  ■
[B][FF1493]──────────────────
[B][FFD700]BASIC
[B][FF1493]├─[00FF00]/bundle [FFFFFF] (bundle list)
[B][FF1493]└─[00FF00]/bundle [FFFFFF] [nm]
[B][FF1493]──────────────────
[B][FFD700]CUSTOM & FAST
[B][FF1493]├─[00FF00]/evo_c [FFFFFF][uids] [num]
[B][FF1493]└─[00FF00]/e [FFFFFF][nm]
[B][FF1493]──────────────────
[B][FFD700]FUN & Tools
[B][FF1493]├─[00FF00]/luck [FFFFFF](luck test)
[B][FF1493]├─[00FF00]/dice [FFFFFF] Game
[B][FF1493]└─[00FF00]/coin [FFFFFF](কয়েন গেম)
[B][FF1493]──────────────"""

                            await safe_send_message(response.Data.chat_type, ad_cmnd, uid, chat_id, key, iv)
                            await asyncio.sleep(0.2)

                            info_cmnd = """[B][4169E1]■ BOT SYSTEM ■
[B][4169E1]──────────────────
[B][FFD700]DEVELOPER INFO
[B][4169E1]├─[FFFFFF]Owner: [FFD700] SIAM_BHAI
[B][4169E1]└─[FFFFFF]TG: @siam_bhai1
[B][4169E1]──────────────────
[B][FF0000]WARNING
...
[B][4169E1]──────────────────"""
                            ...
                            about = """[B][00BFFF]■ EVO & BUNDLE ■
[B][00BFFF]──────────────────
[B][FFD700]EVO SYSTEM
[B][00BFFF]├─[00FF00]/evo [FFFFFF][uids] [num 1-21]
[B][00BFFF]├─[00FF00]/evo_c [FFFFFF][uids] [num]
[B][00BFFF]├─[00FF00]/dance [FFFFFF][uids] [all] [dacn]
[B][00BFFF]└─[00FF00]/stop [FFFFFF](Stop Cycle)
[B][00BFFF]──────────────────
[B][FFD700]FUN & TOOLS
[B][00BFFF]├─[00FF00]/start
[B][00BFFF]├─[00FF00]/bundle [FFFFFF][list]
[B][00BFFF]├─[00FF00]/look[FFFFFF][num]
[B][00BFFF]──────────────────"""
...
[B][C][00FF00] গিল্ড এর নিয়ম পতি সপ্তা এ ❀️2000 গ্লরি দিতে হবে
[FFFF00]━━━━━━━━━━━"""
...
[00FFFF]│ Owner : [FF00FF] SIAM_BHAI (•_- )
[FF0000]│
[FFFF00]│ [FFFF00]IF YOU WANT TO BUY THE BOT
[00FFFF]│ [FFFFFF]MESSAGE ME ON TIKTOK OR TELEGRAM
[00FFFF]│
[00E5FF]└ ID NAME : [00FF00]@siam_bhai1
...
async def MaiiiinE():
    ...
    if not credentials:
        ...
        print("📝 Format: uid=4677704508,password=2392F69EC7C68F3A70AC000C4B303B42E11C7609A179EC52747253415113314A")
        return None
    ...
    os.system('clear')
    print("=" * 50)
    print("🤖 SIAM_BHAI ᅠ BOT - INITIALIZING")
    print("=" * 50)
    ...
    os.system('clear')
    print("🤖 SIAM_BHAIᅠ BOT - CONNECTING")
    print("=" * 50)
    print("┌────────────────────────────────────┐")
    print("│ ██████████████████████████████████ │")
    print("└────────────────────────────────────┘")
